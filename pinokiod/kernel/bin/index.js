        ...
        if (start) {
          ...
          if (chunks.length > 1) {
            ...
            if (name === "conda") {
              ...
              //if (String(version) === "24.9.0") {
              //if (String(version) === "24.7.1") {
              //if (String(version) === "24.11.2") {
            ...
            if (name === "conda-libmamba-solver") {
              ...
              if (String(version) === "24.11.1" && channel === "conda-forge") {
